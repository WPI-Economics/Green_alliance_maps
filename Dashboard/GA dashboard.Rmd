...
<!--     filter_checkbox( -->
<!--     id = "bog", -->
<!--     label = "Within 10k of great north bog", -->
<!--     sharedData = sd, -->
<!--     group = ~`Within 10k of great north bog` -->
<!--   ) -->
<!-- ) -->
...
tbl <- reactable(sd, #selection = "multiple",
                ...
                columns = list(
                          ...
                          #Constituency = colDef(filterable = F),
                 ...
                 theme = reactableTheme(
                   ...
                   headerStyle = list(color = "white",background = "#006784",
                                      "&:hover[aria-sort]" = list(background = "#00946E"),
                                      "&[aria-sort='ascending'], &[aria-sort='descending']" = list(background = "#00946E"),
                                      borderColor = "#00946E"
                   )
                 ))
...
combo <- htmltools::tagList(area.search,dl.button,tbl) 
combo
